...
export default function ParentIvyScoreDashboard() {
    const [scoreData, setScoreData] = useState<IvyScoreData | null>(null);
    const [loading, setLoading] = useState(true);
    const [error, setError] = useState<string | null>(null);

    // TODO: Replace with actual child's student ID from auth context
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-blue-800">
                                ...
                                Scores are automatically updated when the counselor evaluates your child&apos;s submissions. This dashboard provides
