...
function StudentSidebar() {
    ...
    const navItems = [
        {
            name: 'Dashboard', href: `/student${queryString}`, icon: (
        ...
        {
            name: 'Academic Excellence', href: `/student/pointer1${queryString}`, icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Spike in one area', href: `/student/activities${queryString}&pointerNo=2`, icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Leadership & Initiative', href: `/student/activities${queryString}&pointerNo=3`, icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Global or Social Impact', href: `/student/activities${queryString}&pointerNo=4`, icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Authentic & Reflective Storytelling', href: `/student/pointer5${queryString}`, icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Engagement with Learning & Intellectual Curiosity', href: `/student/pointer6${queryString}`, icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <aside className="w-72 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 shadow-sm z-20">
            ...
            <div className="p-6">
                <div className="bg-gray-50 rounded-3xl p-6 border border-gray-100">
                    ...
                    <p className="text-xs font-bold text-gray-900 leading-relaxed uppercase tracking-tight">John Doe</p>
